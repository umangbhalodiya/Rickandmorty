    ...
    <div>
      <div className="full-banner">
            ...
            <div className="header-alignment">
              ...
              <div className="menu">
                <div className="menulist">
                  ...
                  <span
                    onClick={() => {
                      setProductType("Candles");
                    }}
                  >
                    <a>Candles</a>
                  </span>
                </div>
                <div className="baricon" onClick={() => setOpneMenu(!opneMenu)}>
                ...
                {opneMenu && (
                  <div className="mobmenubar">
                    <div className="barheader">
                      ...
                      <ul>
                        <li onClick={() => setOpneMenu(!opneMenu)}>
                          <span
                            onClick={() => {
                              setProductType("Airpod");
                            }}
        ...
        {productType === "Plushies" && (
          <Plushies setPlushyData={setPlushyData} />
        )}
        {productType === "Candles" && <Candles setCandleData={setCandleData} />}
      </div>
      {modalOpen && <div className="modal-blur"></div>}
      <div
        className={
          modalOpen ? "modal-medium modal-show" : "modal-medium modal-hidden"
        }
      >
